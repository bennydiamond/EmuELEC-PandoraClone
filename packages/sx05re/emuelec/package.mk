...
PKG_EXPERIMENTAL="munt nestopiaCV quasi88 xmil np2kai hypseus-singe"
# Removed packages 'yabasanshiroSA', 'fbneoSA' and 'same_cdi' from PKG_EXPERIMENTAL due to compilation issues.
PKG_EMUS="$LIBRETRO_CORES advancemame PPSSPPSDL amiberry hatarisa openbor dosbox-staging mupen64plus-nx mupen64plus-nx-alt stellasa solarus dosbox-pure pcsx_rearmed ecwolf potator freej2me flycastsa fmsx-libretro jzintv"
# Removed packages scummvmsa, 'mupen64plussa' and 'duckstation' from PKG_EMUS due to compilation issues.
